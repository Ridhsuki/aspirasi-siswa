...
<body>
    @php
        ...
        $admin = User::where('role', 'admin')->whereNotNull('nisn')->first();
        $waNumber = null;
        if ($admin && $admin->nisn) {
            $waNumber = $admin->nisn;
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <a href="/" style="text-decoration: none">
            <h2 class="app-title">{{ config('app.name') }}</h2>
        </a>
        ...
        <div class="inputGroup inputGroup2">
            ...
            <div class="forgot-link-container">
                <a href="#" onclick="handleForgotPassword(event)" class="forgot-link">Lupa Password?</a>
            </div>

        </div>

        <div class="inputGroup inputGroup3">
            <button type="submit" id="login" style="cursor: pointer;">Log in</button>
        </div>
    </form>
        ...
        function handleForgotPassword() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (waNumber) {
                        const roleElement = document.getElementById("login-role");
                        const role = roleElement ? roleElement.value : "Siswa";
                        ...
                        Swal.fire({
                            ...
                            text: "Nomor WhatsApp admin belum tersedia. harap hubungi OSIS",
                            icon: "error"
                        })
                    }
                }
